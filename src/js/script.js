      ...
      messages: {
        ...
        text: {
          ...
          minlength: jQuery.validator.format(
            "Мінімально повинно бути {0} символів",
          ),
        },
...
const body = document.querySelector("body"),
  ...
  mobileSearchInput = document.querySelector(
    '[data-element="mobileSearchInput"]',
  ),
  ...
  mobileMenuCloseElem = document.querySelector(
    '[data-element="mobileMenuCloseElem"]',
  ),
  mobilePanelCatalogIcon = document.querySelector(
    '[data-element="catalogMobilePanelLink"]',
  ),
  ...
  mobileCatalogCloseElem = document.querySelector(
    '[data-element="catalogCloseElem"]',
  ),
  mobileCatalogBackElem = document.querySelector(
    '[data-element="mobileCatalogBack"]',
  ),
  mobileForClientLink = document.querySelector(
    '[data-element="forClientLink"]',
  ),
  mobileForClient = document.querySelector('[data-element="mobileForClient"]'),
  mobileForClientCloseElem = document.querySelector(
    '[data-element="mobileForClientCloseElem"]',
  ),
  mobileForClientBackElem = document.querySelector(
    '[data-element="mobileForClientBack"]',
  ),
  mobileCatalogCategoryItem = document.querySelector(
    '[data-element="mobileCatalogCategoryItem"]',
  ),
  mobileCatalogCategory = document.querySelector(
    '[data-element="mobileCatalogCategory"]',
  ),
  mobileCatalogCategoryCloseElem = document.querySelector(
    '[data-element="catalogCategoryCloseElem"]',
  ),
  mobileCatalogCategoryBackElem = document.querySelector(
    '[data-element="mobileCatalogCategoryBack"]',
  ),
  ...
  mobileContactCloseElem = document.querySelector(
    '[data-element="mobileContactCloseElem"]',
  ),
  ...
  mobileCartCloseElem = document.querySelector(
    '[data-element="mobileCartCloseElem"]',
  ),
  mobilePanelViewedIcon = document.querySelector(
    '[data-element="mobileViewed"]',
  ),
  mobileViwedLink = document.querySelector('[data-element="viewedLink"]'),
  mobileViewedMenu = document.querySelector(
    '[data-element="mobileViewedMenu"]',
  ),
  mobileViewedCloseElem = document.querySelector(
    '[data-element="mobileViewedCloseElem"]',
  ),
  mobileViewedBackElem = document.querySelector(
    '[data-element="mobileViewedBack"]',
  ),
  mobilePersonalAccountLink = document.querySelector(
    '[data-element="mobilePersonalAccountLink"]',
  ),
  mobilePersonalAccountMenu = document.querySelector(
    '[data-element="mobilePersonalAccount"]',
  ),
  mobilePersonalAccountCloseElem = document.querySelector(
    '[data-element="mobilePersonalAccountCloseElem"]',
  ),
  mobilePersonalAccountBackElem = document.querySelector(
    '[data-element="mobilePersonalAccountBack"]',
  ),
  mobileTogglePassword = document.querySelector(
    '[data-element="mobileTogglePassword"]',
  ),
  mobilePassword = document.querySelector("#mobile-password"),
  mobileToggleRegPassword = document.querySelector(
    '[data-element="mobileToggleRegPassword"]',
  ),
  mobileRegPassword = document.querySelector("#mobile-registration-password"),
  mobileToggleConfirmPassword = document.querySelector(
    '[data-element="mobileToggleConfirmPassword"]',
  ),
  mobileConfirmPassword = document.querySelector(
    "#mobile-registration-confirm-password",
  ),
  modalTogglePassword = document.querySelector(
    '[data-element="modalTogglePassword"]',
  ),
  modalPassword = document.querySelector("#modal-account-password"),
  modalToggleRegPassword = document.querySelector(
    '[data-element="modalToggleRegPassword"]',
  ),
  modalRegPassword = document.querySelector("#modal-registration-password"),
  modalToggleConfirmPassword = document.querySelector(
    '[data-element="modalToggleConfirmPassword"]',
  ),
  modalConfirmPassword = document.querySelector(
    "#modal-registration-confirm-password",
  ),
  productActionsVolume = document.querySelector(
    '[data-element="productActionsVolume"]',
  ),
  productActionsVolumeBtns = document.querySelectorAll(
    ".product-actions__middle-volume-item",
  ),
  productActionsColor = document.querySelector(
    '[data-element="productActionsColor"]',
  ),
  productActionsColorCheckBoxes = document.querySelectorAll(
    '.product-actions__middle-color input[type="checkbox"]',
  );
    ...
    button.addEventListener("click", function () {
      if (
        !this.classList.contains(
          "product-actions__middle-volume-item_unavailable",
        )
      ) {
...
toggleMobileMenu(
  mobileCatalogLink,
  mobileCatalog,
  mobileCatalogCloseElem,
  mobileCatalogBackElem,
);
toggleMobileMenu(mobilePanelCatalogIcon, mobileCatalog);

toggleMobileMenu(
  mobileCatalogCategoryItem,
  mobileCatalogCategory,
  mobileCatalogCategoryCloseElem,
  mobileCatalogCategoryBackElem,
);
toggleMobileMenu(mobilePanelCartIcon, mobileCartMenu, mobileCartCloseElem);
toggleMobileMenu(
  mobileForClientLink,
  mobileForClient,
  mobileForClientCloseElem,
  mobileForClientBackElem,
);
...
toggleMobileMenu(
  mobileViwedLink,
  mobileViewedMenu,
  mobileViewedCloseElem,
  mobileViewedBackElem,
);

toggleMobileMenu(
  mobilePersonalAccountLink,
  mobilePersonalAccountMenu,
  mobilePersonalAccountCloseElem,
  mobilePersonalAccountBackElem,
);
